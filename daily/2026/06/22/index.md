...
- **P0** OpenAI frontier models 与 Codex 已在 AWS 一般可用
  ...
  - 条目：[结构化记录](../../../../items/2026/06/22/daily/top-02-frontier-models-codex-aws-frontier.md)
...
- **P0** Coding Agent 继续向“持久、安全、企业化环境”演进
  ...
  - 条目：[结构化记录](../../../../items/2026/06/22/daily/top-03-coding-agent-coding-agent-2026.md)
...
- **P1** Agent/RAG 的上下文管理与流式工具调用开始被拆解为可工程化机制
  ...
  - 条目：[结构化记录](../../../../items/2026/06/22/daily/top-04-agent-rag-agent-rag-2026.md)
...
- **P1** 端侧/实时 Agent Serving 需要超越 KV cache 的状态复用
  ...
  - 条目：[结构化记录](../../../../items/2026/06/22/daily/top-05-agent-serving-kv-cache-agent.md)
